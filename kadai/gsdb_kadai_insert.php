...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO gs_gsdb_table(school_num, name, nickname, age, about_work, info, presen, datetime )VALUES(:school_num, :name, :nickname, :age, :about_work, :info, :presen, sysdate())");
